...
*/
#ifndef V3_EXAMPLES_Media_Player_STUB_HPP_
#define V3_EXAMPLES_Media_Player_STUB_HPP_
...
class MediaPlayerStubAdapter
 ...
 public:
    ...
    virtual void fireCurrentTrackAttributeChanged(const ::v3::examples::MediaPlayer::TrackInfo &currentTrack) = 0;
...
public:
    ...
    virtual bool onRemoteSetCurrentTrackAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, ::v3::examples::MediaPlayer::TrackInfo _value) = 0;
...
public:
    ...
    virtual const ::v3::examples::MediaPlayer::TrackInfo &getCurrentTrackAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireCurrentTrackAttributeChanged(::v3::examples::MediaPlayer::TrackInfo _value) {
    ...
    virtual void play(const std::shared_ptr<CommonAPI::ClientId> _client, MediaPlayer::TrackInfo _track) = 0;
...
#endif // V3_EXAMPLES_Media_Player_STUB_HPP_
