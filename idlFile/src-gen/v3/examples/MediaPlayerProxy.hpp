...
*/
#ifndef V3_EXAMPLES_Media_Player_PROXY_HPP_
#define V3_EXAMPLES_Media_Player_PROXY_HPP_

#include <v3/examples/MediaPlayerProxyBase.hpp>
...
public:
     ...
     * will be set.
     */
    virtual void play(MediaPlayer::TrackInfo _track, CommonAPI::CallStatus &_internalCallStatus, std::string &_name);
...
template <typename ... _AttributeExtensions>
void MediaPlayerProxy<_AttributeExtensions...>::play(MediaPlayer::TrackInfo _track, CommonAPI::CallStatus &_internalCallStatus, std::string &_name) {
    delegate_->play(_track, _internalCallStatus, _name);
}
...
struct DefaultAttributeProxyHelper< ::v3::examples::MediaPlayerProxy,
    _AttributeExtension> {
    typedef typename ::v3::examples::MediaPlayerProxy<
            ::v3::examples::MediaPlayerExtensions::CurrentTrackAttributeExtension<_AttributeExtension>
    > class_t;
};
}
...
#endif // V3_EXAMPLES_Media_Player_PROXY_HPP_
