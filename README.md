# fidl-generator
The fidl-generator support a Franca IDL parser which can parse IDL files and build complete model trees. And it also support a IDL code generation tool that can generate various types of code based on the model trees.
...
- [fmt: A modern formatting library](https://github.com/fmtlib/fmt) which is licensed under the MIT, is used by the fidl-generator project to process the strings.
- [nlohmann/json](https://github.com/nlohmann/json) which is licensed under the MIT, is used by the asf generator and test generator in the fidl-generator project.
