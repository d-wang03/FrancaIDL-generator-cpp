...
inline std::string replace_one(std::string &inout, const std::string &what, const std::string &with)
{
...
inline std::string replace_all(std::string &inout, const std::string &what, const std::string &with)
{
...
inline void remove_all(std::string &inout, const std::string &what)
{
    replace_all(inout, what, "");
}

inline std::string join(const std::list<std::string> &list, const std::string &separator)
{
    std::string ret;
...
inline uint32_t count(const std::string &str, const std::string &what)
{
    uint32_t ret = 0;
...
inline std::string toFirstUpper(std::string str)
{
    str[0] = toupper(str[0]);
    return str;
}

inline std::string toFirstLower(std::string str)
{
    str[0] = tolower(str[0]);
    return str;
}
...
inline std::list<std::string> split(const std::string &input, const std::string &splitter)
{
    size_t start_pos = 0;
